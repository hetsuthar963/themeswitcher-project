...
export default function Card() {
    return (
        <div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-700 dark:border-gray-700">
            <a href="/">
                <img className="p-8 mr-7 m-5 pl-8 rounded-t-lg justify-center" src="https://www.apple.com/v/watch/bo/images/overview/select/product_se__frx4hb13romm_large.png" alt="product_image1" />
            </a>
